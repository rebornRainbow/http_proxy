...
CXXFLAGS = -g -Wall -pedantic -O0 -std=c++14 -D_GLIBCXX_USE_NANOSLEEP -D_GLIBCXX_USE_SCHED_YIELD -I../extra/include -I../extra/include $(DEPS)
...
LDFLAGS =  -fPIC -no-pie -lpthread -L../extra/lib -lthreadpool -L../extra/lib -lthreads -L../extra/lib/socket++ -lsocket++ -Wl,-rpath=../extra/lib/socket++
